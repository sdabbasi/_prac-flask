...
from flaskblog.forms import RegistrationFrom, LoginFrom, UpdateAccountFrom, PostForm, RequestResetForm, ResetPasswordForm
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Your password had been updated', 'success')
        return redirect(url_for('login'))
